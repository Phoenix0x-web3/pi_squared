...
class HSForm:
    ...
    async def fill_form(self):
        ...
        logger.info(f"{self.wallet} | {self.__module__} | starting HS Form fill")
        ...
        mp = CurlMime()
        mp.addpart(name="hs_context",
                data=json.dumps(hs_context),
        ...
        mp.addpart(name="role", data=random.choice(
            ["Researcher", "Developer", "Pi Squared Community Member", "Other"]
        ))
